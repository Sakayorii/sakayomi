...
import sakayomi.core.archive.ArchiveEntry as SakayomiArchiveEntry
...
internal class ArchiveInputStream(buffer: Long, size: Long) : InputStream() {
    ...
    fun getNextEntry(): SakayomiArchiveEntry? {
        return Archive.readNextHeader(archive).takeUnless { it == 0L }?.let { entry ->
            ...
            SakayomiArchiveEntry(name, isFile)
        }
    }
}
