...
object TelemetryConfig {
    ...
    fun init(context: Context) {
        ...
        if (!context.isSakayomiProductionApp()) return
    ...
    private fun Context.isSakayomiProductionApp(): Boolean {
...
private val MIHON_PACKAGES = hashSetOf("app.sakayomi", "app.sakayomi.debug")
