package dev.sakayori.sakayomi.data.track.suwayomi
...
class Suwayomi(id: Long) : BaseTracker(id, "Suwayomi"), EnhancedTracker {
    ...
    override fun getAcceptedSources(): List<String> = listOf("dev.sakayori.sakayomi.extension.all.tachidesk.Tachidesk")
