package dev.sakayori.sakayomi.ui.main
...
import dev.sakayori.presentation.components.AppStateBanners
import dev.sakayori.presentation.components.DownloadedOnlyBannerBackgroundColor
import dev.sakayori.presentation.components.IncognitoModeBannerBackgroundColor
import dev.sakayori.presentation.components.IndexingBannerBackgroundColor
import dev.sakayori.presentation.more.settings.screen.browse.ExtensionReposScreen
import dev.sakayori.presentation.more.settings.screen.data.RestoreBackupScreen
import dev.sakayori.presentation.util.AssistContentScreen
import dev.sakayori.presentation.util.DefaultNavigatorScreenTransition
...
import dev.sakayori.sakayomi.data.updater.AppUpdateChecker
import dev.sakayori.sakayomi.extension.api.ExtensionApi
import dev.sakayori.sakayomi.ui.base.activity.BaseActivity
import dev.sakayori.sakayomi.ui.browse.source.browse.BrowseSourceScreen
import dev.sakayori.sakayomi.ui.browse.source.globalsearch.GlobalSearchScreen
import dev.sakayori.sakayomi.ui.deeplink.DeepLinkScreen
import dev.sakayori.sakayomi.ui.home.HomeScreen
import dev.sakayori.sakayomi.ui.manga.MangaScreen
import dev.sakayori.sakayomi.ui.more.NewUpdateScreen
import dev.sakayori.sakayomi.ui.more.OnboardingScreen
import dev.sakayori.sakayomi.util.system.dpToPx
import dev.sakayori.sakayomi.util.system.isNavigationBarNeedsScrim
import dev.sakayori.sakayomi.util.system.updaterEnabled
...
class MainActivity : BaseActivity() {
    ...
    private fun handleIntentAction(intent: Intent, navigator: Navigator): Boolean {
        ...
        val tabToOpen = when (intent.action) {
            ...
            Intent.ACTION_VIEW -> {
                ...
                else if (intent.scheme == "sakayomi" && intent.data?.host == "add-repo") {
    ...
    companion object {
        const val INTENT_SEARCH = "dev.sakayori.sakayomi.SEARCH"
