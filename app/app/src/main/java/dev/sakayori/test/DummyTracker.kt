...
data class DummyTracker(
    ...
    override suspend fun update(
        track: dev.sakayori.sakayomi.data.database.models.Track,
        didReadChapter: Boolean,
    ): dev.sakayori.sakayomi.data.database.models.Track = track
    ...
    override suspend fun register(
        item: dev.sakayori.sakayomi.data.database.models.Track,
        mangaId: Long,
    ) = Unit
