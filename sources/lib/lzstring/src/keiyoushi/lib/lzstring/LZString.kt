package Sakayorii.lib.lzstring
...
object LZString {
    ...
    private const val BASE_64_KEY_STR = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="

    fun compressToBase64(input: String): String = compress(input, 6) { BASE_64_KEY_STR[it].toString() }.let {
    ...
    fun decompressFromBase64(input: String): String = decompress(input.length, 32) {
        BASE_64_KEY_STR.indexOf(input[it])
    }
}
