package dev.sakayori.sakayomi.extension.ar.yurimoonsub
...
class YuriMoonSub :
    ...
    override fun getChapterFeedUrl(doc: Document): String = URLDecoder.decode(super.getChapterFeedUrl(doc), StandardCharsets.UTF_8.toString())
        .removeArabicChars()
