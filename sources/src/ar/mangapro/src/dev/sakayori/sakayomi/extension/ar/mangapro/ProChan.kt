package dev.sakayori.sakayomi.extension.ar.mangapro
...
import Sakayorii.utils.extractNextJs
import Sakayorii.utils.extractNextJsRsc
import Sakayorii.utils.firstInstance
import Sakayorii.utils.parseAs
import Sakayorii.utils.toJsonString
...
import sakayomi.decoder.ImageDecoder
            ...
            orderedPieces.map { pieceUrl ->
                async(Dispatchers.IO.limitedParallelism(2)) {
                    ...
                    response.body.use { body ->
                        // use Sakayomi ImageDecoder because android.graphics.BitmapFactory doesn't handle avif
