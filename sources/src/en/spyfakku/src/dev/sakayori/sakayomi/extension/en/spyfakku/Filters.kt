package dev.sakayori.sakayomi.extension.en.spyfakku

import dev.sakayori.sakayomi.source.model.Filter
import dev.sakayori.sakayomi.source.model.Filter.Sort.Selection
...
internal open class SelectFilter(name: String, val vals: List<String>, state: Int = 2) : Filter.Select<String>(name, vals.map { it }.toTypedArray(), state)
