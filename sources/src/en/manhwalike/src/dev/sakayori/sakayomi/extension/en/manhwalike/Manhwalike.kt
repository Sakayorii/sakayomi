package dev.sakayori.sakayomi.extension.en.manhwalike

import dev.sakayori.sakayomi.extension.en.manhwalike.ManhwalikeHelper.buildApiHeaders
import dev.sakayori.sakayomi.extension.en.manhwalike.ManhwalikeHelper.toDate
import dev.sakayori.sakayomi.extension.en.manhwalike.ManhwalikeHelper.toFormRequestBody
import dev.sakayori.sakayomi.extension.en.manhwalike.ManhwalikeHelper.toOriginal
import dev.sakayori.sakayomi.extension.en.manhwalike.ManhwalikeHelper.toStatus
...
class Manhwalike : ParsedHttpSource() {
    ...
    // pages
    override fun pageListParse(document: Document): List<Page> = document.select(".chapter-content .page-chapter img").mapIndexed { i, img ->
