package dev.sakayori.sakayomi.extension.en.myhentaicomics
...
class MyHentaiComics : ParsedHttpSource() {
    ...
    // Pages
    override fun pageListParse(document: Document): List<Page> = document.select("div.comic-thumb > img").mapIndexed { i, e ->
