package dev.sakayori.sakayomi.extension.en.myhentaigallery
...
class MyHentaiGallery : ParsedHttpSource() {
    ...
    override fun mangaDetailsParse(document: Document): SManga = document.selectFirst("div.comic-header")!!.let { info ->
        SManga.create().apply {
