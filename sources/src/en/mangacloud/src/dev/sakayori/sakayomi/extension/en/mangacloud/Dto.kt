package dev.sakayori.sakayomi.extension.en.mangacloud
...
class Manga(
    ...
    fun toSManga(): SManga {
        ...
        val groupTags = listOf("dev.sakayori.sakayomi.sy", "app.komikku")
            .any { app?.startsWith(it) == true }
        val markdownDescription = listOf("app.sakayomi", "dev.sakayori.sakayomi.sy", "app.komikku")
            .any { app?.startsWith(it) == true }
