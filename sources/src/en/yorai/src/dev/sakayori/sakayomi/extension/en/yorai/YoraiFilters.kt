package dev.sakayori.sakayomi.extension.en.yorai
...
internal class GenreFilter(name: String, genreList: List<String>) : Filter.Group<CheckBoxFilter>(name, genreList.map { CheckBoxFilter(it) })
