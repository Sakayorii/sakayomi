...
import dev.sakayori.sakayomi.multisrc.mangareader.MangaReader.UriFilter
import dev.sakayori.sakayomi.multisrc.mangareader.MangaReader.UriMultiSelectFilter
import dev.sakayori.sakayomi.multisrc.mangareader.MangaReader.UriPartFilter
...
class YearFilter(name: String, param: String) :
    UriPartFilter(
        name,
        param,
        years,
...
class MonthFilter(name: String, param: String) :
    UriPartFilter(
        name,
        param,
        months,
...
class DayFilter(name: String, param: String) :
    UriPartFilter(
        name,
        param,
        days,
...
) : Filter.Group<UriPartFilter>("$type Date", values),
    UriFilter {
