package dev.sakayori.sakayomi.extension.all.baobua
...
class BaoBua : SimpleParsedHttpSource() {
    ...
    // region Search
    override fun fetchSearchManga(page: Int, query: String, filters: FilterList): Observable<MangasPage> = if (query.isBlank()) {
