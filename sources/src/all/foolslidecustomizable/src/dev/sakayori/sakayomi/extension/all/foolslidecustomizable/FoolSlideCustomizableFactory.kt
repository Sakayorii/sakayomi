package dev.sakayori.sakayomi.extension.all.foolslidecustomizable

import android.widget.Toast
import androidx.preference.EditTextPreference
import androidx.preference.PreferenceScreen
import dev.sakayori.sakayomi.AppInfo
import dev.sakayori.sakayomi.multisrc.foolslide.FoolSlide
...
class FoolSlideCustomizable : FoolSlide("FoolSlide Customizable", "", "other") {
    ...
    companion object {
        ...
        private const val RESTART_TACHIYOMI = "Restart Sakayomi to apply new setting."
    }
}
