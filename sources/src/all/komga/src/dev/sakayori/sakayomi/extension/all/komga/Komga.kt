package dev.sakayori.sakayomi.extension.all.komga
...
import dev.sakayori.sakayomi.extension.all.komga.dto.AuthorDto
import dev.sakayori.sakayomi.extension.all.komga.dto.BookDto
import dev.sakayori.sakayomi.extension.all.komga.dto.CollectionDto
import dev.sakayori.sakayomi.extension.all.komga.dto.LibraryDto
import dev.sakayori.sakayomi.extension.all.komga.dto.PageDto
import dev.sakayori.sakayomi.extension.all.komga.dto.PageWrapperDto
import dev.sakayori.sakayomi.extension.all.komga.dto.ReadListDto
import dev.sakayori.sakayomi.extension.all.komga.dto.SeriesDto
...
open class Komga(private val suffix: String = "") :
    ...
    override fun headersBuilder() = super.headersBuilder()
        .set("User-Agent", "SakayomiKomga/${AppInfo.getVersionName()}")
        .also { builder ->
        ...
        if (suffix.isEmpty()) {
            ListPreference(screen.context).apply {
                ...
                setOnPreferenceChangeListener { _, _ ->
                    Toast.makeText(screen.context, "Restart Sakayomi to apply new setting.", Toast.LENGTH_LONG).show()
                    true
                }
