package dev.sakayori.sakayomi.extension.all.beauty3600000
...
class Beauty3600000 : ParsedHttpSource() {
    ...
    private fun getGenres(element: Element): List<String> = element.select(".cat-links a, .tags-links a")
        .map { it.text() }
    ...
    // https://github.com/komikku-app/komikku/blob/4323fd5841b390213aa4c4af77e07ad42eb423fc/source-api/src/commonMain/kotlin/eu/kanade/sakayomi/source/CatalogueSource.kt#L176-L184
    @Suppress("Unused")
