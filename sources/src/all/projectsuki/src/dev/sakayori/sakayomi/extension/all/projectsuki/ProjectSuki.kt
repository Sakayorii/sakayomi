package dev.sakayori.sakayomi.extension.all.projectsuki

import android.os.Build
import androidx.preference.PreferenceScreen
import dev.sakayori.sakayomi.extension.all.projectsuki.activities.INTENT_BOOK_QUERY_PREFIX
import dev.sakayori.sakayomi.extension.all.projectsuki.activities.INTENT_READ_QUERY_PREFIX
import dev.sakayori.sakayomi.extension.all.projectsuki.activities.INTENT_SEARCH_QUERY_PREFIX
import dev.sakayori.sakayomi.extension.all.projectsuki.activities.ProjectSukiSearchUrlActivity
 ...
 * [Sakayomi](https://github.com/sakayoristudio/sakayomi)
 * [extension](https://github.com/sakayoristudio/sakayomi-extensions)
 *
...
internal val reportPrefix: String
    get() = """Error! Report on GitHub (sakayoristudio/sakayomi-extensions)"""
...
/** Throws a [ProjectSukiException], which will get caught by Sakayomi: the message will be exposed as a [toast][android.widget.Toast]. */
...
/**
 * Actual Sakayomi extension, ties everything together.
 *
...
class ProjectSuki :
     ...
     *
     * Thanks to Sakayomi's [NetworkHelper](https://github.com/sakayoristudio/sakayomi/blob/58daedc89ee18d04e7af5bab12629680dba4096c/core/src/main/java/eu/kanade/sakayomi/network/NetworkHelper.kt#L21C12-L21C12)
     ...
     *
     * [SManga]'s thumbnail_url should instead be in absolute form. If possible [it should be set](https://github.com/sakayoristudio/sakayomi-extensions/blob/master/CONTRIBUTING.md#popular-manga)
    ...
    /**
     * Function that is responsible for providing Sakayomi with an [Observable](https://reactivex.io/documentation/observable.html)
     * that will return a single [MangasPage] (Sakayomi uses [Observable.single] behind the scenes).
     *
     ...
     * Otherwise Sakayomi will just wait for the Observable forever (or until a timeout).
     *
