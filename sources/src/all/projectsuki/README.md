...
[Extension FAQ](https://sakayomi.sakayori.dev/help/faq/#extensions) or
[Getting Started](https://sakayomi.sakayori.dev/help/guides/getting-started/#installation).

If you still don't find the answer you're looking for you're welcome to open an
[issue](https://github.com/sakayoristudio/sakayomi-extensions/issues)
...
- If you know the bookID of a manga you want to search for, you can search for it directly by typing
  `book/<bookID>` in the search bar in the Sakayomi app, this works for `read/<bookID>` too, with
