...
Don't find the question you are look for go check out our general FAQs and Guides over at [Extension FAQ](https://sakayomi.sakayori.dev/help/faq/#extensions) or [Getting Started](https://sakayomi.sakayori.dev/help/guides/getting-started/#installation)
...
You need to [migrate](https://sakayomi.sakayori.dev/help/guides/source-migration/) all your MangaDex manga from MangaDex to MangaDex as MangaDex has changed their manga ID system from IDs to UUIDs.
...
### What does the Status of a Manga in Sakayomi mean?

Please refer to the following table

| Status in Sakayomi | in MangaDex            | Remarks |
|---------------------|------------------------|---------|
...
Follow the following steps to easily block a group from the Sakayomi MangaDex extension:
...
B. Blocking a group using their UUID in Sakayomi MangaDex extension `v1.2.150+`:
