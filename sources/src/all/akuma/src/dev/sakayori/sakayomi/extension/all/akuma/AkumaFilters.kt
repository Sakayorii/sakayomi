package dev.sakayori.sakayomi.extension.all.akuma
...
internal class CategoryFilter : Filter.Group<Filter.TriState>("Categories", categoryList.map { TagTriState(it) })
