package dev.sakayori.sakayomi.extension.zh.baimangu
...
class Baimangu :
    ...
    companion object {
        private const val TOAST_RESTART = "請重新启动sakayomi"
        ...
        /** This value affects connection request amount to main site. Lowering this value may reduce the chance to get HTTP 403 error, but loading speed will be slower too. Sakayomi restart required. Current value: %s" */
        ...
        /** This value affects the delay when hitting the connection limit to main site. Increasing this value may reduce the chance to get HTTP 403 error, but loading speed will be slower too. Sakayomi restart required. Current value: %s" */
