package dev.sakayori.sakayomi.extension.ja.hachiraw

import dev.sakayori.sakayomi.source.model.Filter

class SortFilter(state: Int = 2) :
    SelectFilter(
        "Sort By",
        listOf(
...
open class SelectFilter(name: String, val items: List<Selection>, state: Int = 0) :
